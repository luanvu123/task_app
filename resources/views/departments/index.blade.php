                    ...
                    <div
                        ...
                        <div class="col-auto d-flex w-sm-100">
                            <button type="button" class="btn btn-dark btn-set-task w-sm-100" data-bs-toggle="modal"
                                data-bs-target="#depadd"><i class="icofont-plus-circle me-2 fs-6"></i>Thêm Phòng
                                Ban</button>
                        </div>
                    </div>
                </div>
                                            ...
                                            <td>
                                                @if($department->departmentHead)
                                                    @php
                                                        ...
                                                        $avatarPath = $department->departmentHead->image
                                                            ? asset('storage/' . $department->departmentHead->image)
                                                            : asset('assets/images/xs/avatar1.jpg'); // ảnh mặc định
                                                    @endphp
                                                    <img class="avatar rounded-circle" src="{{ $avatarPath }}"
                                                        alt="{{ $department->departmentHead->name }}"
                                                        onerror="this.src='{{ asset('assets/images/xs/avatar1.jpg') }}'">
            ...
            <div class="modal-content">
                <form method="POST" action="{{ route('departments.store') }}">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="department_name" class="form-label">Tên Phòng Ban <span
        ...
        <div class="modal-dialog modal-dialog-centered modal-md modal-dialog-scrollable">
            <div class="modal-content">
                <form method="POST" id="editForm">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="edit_department_name" class="form-label">Tên Phòng Ban <span
                                    class="text-danger">*</span></label>

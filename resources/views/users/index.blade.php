                                ...
                                <div class="card-body d-flex">
                                    <div class="profile-av pe-xl-4 pe-md-2 pe-sm-4 pe-4 text-center w220">
                                        <img src="{{ $user->image ? asset('storage/' . $user->image) : asset('assets/images/lg/avatar3.jpg') }}"
                                            alt="{{ $user->name }}" class="avatar xl rounded-circle img-thumbnail shadow-sm">
                                    ...
                                    <div class="teacher-info border-start ps-xl-4 ps-md-3 ps-sm-4 ps-4 w-100">
                                        ...
                                        <span
                                            class="@if($user->status == 'active') light-success-bg @elseif($user->status == 'inactive') light-danger-bg @else light-warning-bg @endif py-1 px-2 rounded-1 d-inline-block fw-bold small-11 mb-0 mt-1">
                                        ...
                                        <div class="mt-2">
                                            ...
                                            @if($user->dob)
                                                <small class="text-muted d-block">
                                                    <i
                                                        class="icofont-calendar me-1"></i>{{ \Carbon\Carbon::parse($user->dob)->format('d/m/Y') }}
                                                </small>
                                            @endif
                                        </div>
            ...
            <div class="modal-content">
                <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col">
                                ...
                                <select class="form-select" id="position" name="position">
                                    ...
                                    <option value="Marketing" {{ old('position') == 'Marketing' ? 'selected' : '' }}>Marketing
                                    </option>
                        ...
                        <div class="mb-3">
                            <label for="department_id" class="form-label">Phòng ban <span
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="status" name="status">
                                ...
                                <option value="suspended" {{ old('status') == 'suspended' ? 'selected' : '' }}>Tạm dừng
                                </option>
                            </select>
                        </div>
                    </div>

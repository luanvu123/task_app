            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="card-title mb-0">Thêm nhà cung cấp mới</h3>
                        </div>
                        <div class="col-auto">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="specialties[]"
                                               ...
                                               {{ in_array('Công nghệ thông tin', old('specialties', [])) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="specialties[]"
                                               ...
                                               {{ in_array('Xây dựng', old('specialties', [])) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="specialties[]"
                                               ...
                                               {{ in_array('Vận tải', old('specialties', [])) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="specialties[]"
                                               ...
                                               {{ in_array('Thiết bị văn phòng', old('specialties', [])) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="specialties[]"
                                               ...
                                               {{ in_array('Dịch vụ tư vấn', old('specialties', [])) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="specialties[]"
                                               ...
                                               {{ in_array('Khác', old('specialties', [])) ? 'checked' : '' }}>
